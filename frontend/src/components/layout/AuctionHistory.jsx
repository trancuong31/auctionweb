...
const AuctionHistory = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-8 bg-gray-50">
      {/* Modal Overlay */}
      {isOpen && (
            ...
            <div className="flex-1 p-4 sm:p-6 overflow-y-auto max-h-[calc(95vh-120px)]">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">ID: {truncateId(bid.id)}</p>
                            </div>
                          </div>
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4">
                  <div className="text-blue-600 text-sm font-medium">Total Bids</div>
                  <div className="text-2xl font-bold text-blue-700">{auctionHistory.length}</div>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4">
                  <div className="text-green-600 text-sm font-medium">Winning Bids</div>
                  <div className="text-2xl font-bold text-green-700">
                    {auctionHistory.filter(bid => bid.is_winner).length}
                  </div>
                </div>
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-4">
                  <div className="text-orange-600 text-sm font-medium">Highest Value</div>
                  <div className="text-lg font-bold text-orange-700">
                    {formatCurrency(Math.max(...auctionHistory.map(bid => bid.bid_amount)))}
                  </div>
                </div>
